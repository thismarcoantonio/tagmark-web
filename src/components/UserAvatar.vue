<template>
  <main-menu>
    <template #activator>
      <div
        class="flex h-13 w-13 items-center justify-center rounded-full border border-b-4 border-gray-600 bg-blue-500 font-bold text-white decoration-0 hover:bg-blue-700"
      >
        MA
      </div>
    </template>
